...
const TRANSFORM_ICONS = {
  // 白色 5種
  wolf:      assetUrl('aadkrfq7ekgbw_ve_miaoda'),
  guardian:  assetUrl('aadkrfrpna4bw_ve_miaoda'),
  berserker: assetUrl('aadkrfrci5egw_ve_miaoda'),
  goblin:    assetUrl('aadkrfs7mfuhu_ve_miaoda'),
  skeleton:  assetUrl('aadkrfsl32kdu_ve_miaoda'),
  // 綠色 5種
  blade:     assetUrl('aadkrfs34tstw_ve_miaoda'),
  shadow:    assetUrl('aadkrftp3eqpu_ve_miaoda'),
  knight:    assetUrl('aadkrftm5eshw_ve_miaoda'),
  elfranger: assetUrl('aadkrfpvoqecu_ve_miaoda'),
  dwarf:     assetUrl('aadkrfqj3ioew_ve_miaoda'),
  // 藍色 5種
  fireknight:  assetUrl('aadkrfo6tm2du_ve_miaoda'),
  icemage:     assetUrl('aadkrfoee3uaw_ve_miaoda'),
  windwalker:  assetUrl('aadkrfrk26ybs_ve_miaoda'),
  paladin:     assetUrl('aadkrftm5eshw_ve_miaoda'),
  orcshaman:   assetUrl('aadkrfqh7dkfw_ve_miaoda'),
  // 紅色 5種
  deathknight: assetUrl('aadkrfs5eiyru_ve_miaoda'),
  demonhunter: assetUrl('aadkrftnde4bs_ve_miaoda'),
  darklord:    assetUrl('aadkrfrob2acs_ve_miaoda'),
  vampire:     assetUrl('aadkrfqjgryaw_ve_miaoda'),
  darkmage:    assetUrl('aadkrfrob2acs_ve_miaoda'),
  // 紫色 5種
  dragonknight: assetUrl('aadkrfrowjojs_ve_miaoda'),
  archmage:     assetUrl('aadkrfrzafyjw_ve_miaoda'),
  phoenix:      assetUrl('aadkrfroybqlu_ve_miaoda'),
  lichking:     assetUrl('aadkrfree5wmw_ve_miaoda'),
  darkangel:    assetUrl('aadkrfnkcb4ru_ve_miaoda'),
  // 金色 5種
  emperor:    assetUrl('aadkrfrzafykw_ve_miaoda'),
  godofwar:   assetUrl('aadkrfroybqku_ve_miaoda'),
  absolute:   assetUrl('aadkrfqip3wes_ve_miaoda'),
  golddragon: assetUrl('aadkrftfgucbs_ve_miaoda'),
  saint:      assetUrl('aadkrfrewywhu_ve_miaoda'),
};
