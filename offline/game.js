...
const SPRITE = {
  ...
  // ---------- 金色神話 ----------
  death_knight: {
    idle: 'assets/sZCb8OB6bL.png',
    walk: 'assets/sZCb8OB6bL.png',
    walk2: 'assets/kjXnwP6c6Q.png',
    walk3: 'assets/9L5kJRdXkU.png',
    walk4: 'assets/GsVeRxnwhk.png',
    attack: 'assets/95MOzrPXE4.png',
    attack2: 'assets/5V9228QzVY.png',
    hit: 'assets/QUmDnQmu2V.png',
    color: '#2a2030', glow: '#60ff60', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#60ff80',
  },
  ishti: {
    idle: 'assets/3bD1z9o8eg.png',
    walk: 'assets/3bD1z9o8eg.png',
    walk2: 'assets/Bb4unEW6Or.png',
    walk3: 'assets/5qCBEK1sLt.png',
    walk4: 'assets/PblYU3LYWK.png',
    attack: 'assets/IVTvgZd0UQ.png',
    attack2: 'assets/LPEiyQx9Rw.png',
    hit: 'assets/tYgMztu4TJ.png',
    color: '#508070', glow: '#80d0b0', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#a0ffd0',
  },
  reya: {
    idle: 'assets/fyAgs0rT2U.png',
    walk: 'assets/fyAgs0rT2U.png',
    walk2: 'assets/ipvu758c68.png',
    walk3: 'assets/rUNpaVcNTV.png',
    walk4: 'assets/JopDfIOw63.png',
    attack: 'assets/JXKMtQDjka.png',
    attack2: 'assets/teo6Rq0FDT.png',
    hit: 'assets/twKeG7UsnN.png',
    color: '#402030', glow: '#ff70a0', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#ff90c0',
  },
  baphomet: {
    idle: 'assets/8KOIwItpMd.png',
    walk: 'assets/8KOIwItpMd.png',
    walk2: 'assets/IRN6nMGdEI.png',
    walk3: 'assets/TzCUCDhjcu.png',
    walk4: 'assets/6PUkZUgPkd.png',
    attack: 'assets/nYsO49hDwZ.png',
    attack2: 'assets/p930ZQKLDY.png',
    hit: 'assets/JktTBAZnKa.png',
  ...
  // ---------- 紫色傳說 ----------
  demon_hunter: {
    idle: 'assets/X25020KITK.png',
    walk: 'assets/X25020KITK.png',
    walk2: 'assets/cUjFPtZ0qW.png',
    walk3: 'assets/tVVnum1RHF.png',
    walk4: 'assets/UNXOnnvtkr.png',
    attack: 'assets/oDD0P2I05N.png',
    attack2: 'assets/oDD0P2I05N.png',
    hit: 'assets/libIUSPFdr.png',
    color: '#701a1a', glow: '#e04040', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#ff8060',
  },
  illusionist: {
    idle: 'assets/hkUGU9PcrJ.png',
    walk: 'assets/hkUGU9PcrJ.png',
    walk2: 'assets/8hLX21hIX7.png',
    walk3: 'assets/VIhy8YlPG3.png',
    walk4: 'assets/fo7IkKOdCV.png',
    attack: 'assets/DQ2zKd6PlE.png',
    attack2: 'assets/DQ2zKd6PlE.png',
    hit: 'assets/ymSWLgEVKA.png',
    color: '#6040a0', glow: '#a080ff', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#c0a0ff',
  },
  anubis: {
    idle: 'assets/MD0YV0uUp3.png',
    walk: 'assets/MD0YV0uUp3.png',
    walk2: 'assets/77Di514UHF.png',
    walk3: 'assets/UHhTcjVpkB.png',
    walk4: 'assets/EesMLrHMPq.png',
    attack: 'assets/qzfRRcBskj.png',
    attack2: 'assets/qzfRRcBskj.png',
    hit: 'assets/hFbVk7Wv8K.png',
    color: '#303020', glow: '#e0c060', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#ffd880',
  },
  chaos_knight: {
    idle: 'assets/ZOAUXTCkwq.png',
    walk: 'assets/ZOAUXTCkwq.png',
    walk2: 'assets/sXiSWjgOUW.png',
    walk3: 'assets/1mwrtdUjUW.png',
    walk4: 'assets/EVisbZLQtX.png',
    attack: 'assets/fOknq8rtA6.png',
    attack2: 'assets/tIU5IOjXsC.png',
    hit: 'assets/pr2EY6HfKb.png',
    color: '#302030', glow: '#a04060', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#c06060',
  },
  shadow_assassin: {
    idle: 'assets/iY86u9q36V.png',
    walk: 'assets/iY86u9q36V.png',
    walk2: 'assets/IgQ8xDV3U4.png',
    walk3: 'assets/3qi2k1tCkD.png',
    walk4: 'assets/VMWbMkUyXH.png',
    attack: 'assets/L0GFiAC4BR.png',
    attack2: 'assets/xpE72e816U.png',
    hit: 'assets/JHRLHgLeB7.png',
    color: '#202030', glow: '#6060a0', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#8080d0',
  },
  holy_envoy: {
    idle: 'assets/UZK9QQSG8O.png',
    walk: 'assets/UZK9QQSG8O.png',
    walk2: 'assets/Qph4YNxnpW.png',
    walk3: 'assets/IpcEagfwmT.png',
    walk4: 'assets/aNZwWxt8wX.png',
    attack: 'assets/VQQHfjBleU.png',
    attack2: 'assets/Ffq0Ozp9WT.png',
    hit: 'assets/WJDNaGLHAt.png',
    color: '#c0a040', glow: '#fff0a0', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#ffffff',
  },
  divine_envoy: {
    idle: 'assets/K5xHlNU28s.png',
    walk: 'assets/K5xHlNU28s.png',
    walk2: 'assets/tfleZSU2QM.png',
    walk3: 'assets/XqAIeRurL0.png',
    walk4: 'assets/tyr9eGSGRp.png',
    attack: 'assets/8neMJjtvhr.png',
    attack2: 'assets/FizXHwVIDs.png',
    hit: 'assets/NsjVkvEGJF.png',
  ...
  // ---------- 紅色史詩 ----------
  balrog: {
    idle: 'assets/tdkg3als9P.png',
    walk: 'assets/tdkg3als9P.png',
    walk2: 'assets/K9NBB7cGSb.png',
    walk3: 'assets/YzTgNSPMxr.png',
    walk4: 'assets/a9s53qaahR.png',
    attack: 'assets/s88OAtsBTM.png',
    attack2: 'assets/UkrwvfPntT.png',
    hit: 'assets/rU1ioEhNRd.png',
    color: '#601010', glow: '#ff6030', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#ff9040',
  },
  dark_knight_red: {
    idle: 'assets/MGWIDhAmHM.png',
    walk: 'assets/MGWIDhAmHM.png',
    walk2: 'assets/dr9VJVQW76.png',
    walk3: 'assets/tjZe2VQqCV.png',
    walk4: 'assets/i4rVzQcOe5.png',
    attack: 'assets/BODZUpyXSI.png',
    attack2: 'assets/je8dqUMZZI.png',
    hit: 'assets/nqcRUI3qJU.png',
    color: '#201028', glow: '#ff3030', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#ff4040',
  },
  dark_mage_red: {
    idle: 'assets/zrnCCihNJt.png',
    walk: 'assets/zrnCCihNJt.png',
    walk2: 'assets/BiBfVufViZ.png',
    walk3: 'assets/nIVWCJVzvT.png',
    walk4: 'assets/kfSS24e8lc.png',
    attack: 'assets/YifczyXetY.png',
    attack2: 'assets/DCr5DPCmxk.png',
    hit: 'assets/CRvwT4vtVx.png',
    color: '#300040', glow: '#c040ff', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#d060ff',
  },
  dark_sorcerer: {
    idle: 'assets/gZssWp0Yaq.png',
    walk: 'assets/gZssWp0Yaq.png',
    walk2: 'assets/iTVLHzirHU.png',
    walk3: 'assets/FfzUQzcUjH.png',
    walk4: 'assets/Ni2RrhDZ1j.png',
    attack: 'assets/8hb1wWKeFd.png',
    attack2: 'assets/yzizeV2vZe.png',
    hit: 'assets/9j6fRyQNOL.png',
    color: '#401050', glow: '#ff50c0', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#ff80d0',
  },
  dark_assassin_red: {
    idle: 'assets/ZOURHhq9xO.png',
    walk: 'assets/ZOURHhq9xO.png',
    walk2: 'assets/8UiDnbHq3e.png',
    walk3: 'assets/UGv0OG7wbW.png',
    walk4: 'assets/KXQqHrFfFL.png',
    attack: 'assets/EIpWEIeVMj.png',
    attack2: 'assets/WaGtGiouSs.png',
    hit: 'assets/9dOsER3iAQ.png',
    color: '#101018', glow: '#ff2060', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#ff4080',
  },
  ghost_archer: {
    idle: 'assets/P9nRBRY0yz.png',
    walk: 'assets/P9nRBRY0yz.png',
    walk2: 'assets/3jWWxnd4sb.png',
    walk3: 'assets/T6U5hG7RQH.png',
    walk4: 'assets/X6JwwPTJvv.png',
    attack: 'assets/Z6uaGG4xJS.png',
    attack2: 'assets/oqrXlRj3Z5.png',
    hit: 'assets/AKVEuZjd4f.png',
    color: '#203040', glow: '#60c0ff', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#80e0ff',
  },
  silver_knight_galahad: {
    idle: 'assets/LEtxcl2amQ.png',
    walk: 'assets/LEtxcl2amQ.png',
    walk2: 'assets/1BinCuwimp.png',
    walk3: 'assets/vaVKLURbXq.png',
    walk4: 'assets/VlwJcbZBZg.png',
    attack: 'assets/c2pcXyCAoC.png',
    attack2: 'assets/UBsEfc2hXx.png',
    hit: 'assets/MwmmkPb6gf.png',
  ...
  // ---------- 藍色稀有（新變身） ----------
  frost_knight: {
    idle: 'assets/AXY4DIQe2G.png',
    walk: 'assets/AXY4DIQe2G.png',
    walk2: 'assets/G3QcnMpuCP.png',
    walk3: 'assets/ef7gCUKojx.png',
    walk4: 'assets/KfG4vGHfBg.png',
    attack: 'assets/F9QCsN3SUJ.png',
    attack2: 'assets/DagRO0Zu0O.png',
    hit: 'assets/GP2tFT10gV.png',
    color: '#204060', glow: '#60c0ff', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#80d0ff',
  },
  berserker_blue: {
    idle: 'assets/WoJbCl806L.png',
    walk: 'assets/WoJbCl806L.png',
    walk2: 'assets/lJuFzWMxAU.png',
    walk3: 'assets/0behWSGxwq.png',
    walk4: 'assets/hZVlq8jqks.png',
    attack: 'assets/il72r9FzSj.png',
    attack2: 'assets/D6U5t601Rd.png',
    hit: 'assets/RuWfBBWE3q.png',
    color: '#304060', glow: '#70a0ff', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#90b0ff',
  },
  frost_mage: {
    idle: 'assets/5S1tUIsls4.png',
    walk: 'assets/5S1tUIsls4.png',
    walk2: 'assets/4im8YcndVt.png',
    walk3: 'assets/yavRrKoSfb.png',
    walk4: 'assets/MwULW9MFX6.png',
    attack: 'assets/OncrG5zfYk.png',
    attack2: 'assets/J9PLJTHNOp.png',
    hit: 'assets/4FHggRV3UL.png',
    color: '#203060', glow: '#80c0ff', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#a0d0ff',
  },
  lightning_mage: {
    idle: 'assets/Ke1R2tYyYi.png',
    walk: 'assets/Ke1R2tYyYi.png',
    walk2: 'assets/i9ohDah6fK.png',
    walk3: 'assets/1yaLUBo60m.png',
    walk4: 'assets/Jf0iOCYab0.png',
    attack: 'assets/qdmsMhWgqS.png',
    attack2: 'assets/vnhVMY1Mbl.png',
    hit: 'assets/zZYmJKREfl.png',
    color: '#302060', glow: '#a080ff', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#b090ff',
  },
  elf_archer_blue: {
    idle: 'assets/DA1JiUu25C.png',
    walk: 'assets/DA1JiUu25C.png',
    walk2: 'assets/mKkn8z5w9j.png',
    walk3: 'assets/QzBWNKPsY4.png',
    walk4: 'assets/boUCARKlUK.png',
    attack: 'assets/uzOCokO05x.png',
    attack2: 'assets/L2mcusQPUi.png',
    hit: 'assets/lVvCMQkXCa.png',
    color: '#205060', glow: '#60e0d0', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#80f0e0',
  },
  wind_walker: {
    idle: 'assets/A9YN2hiCuY.png',
    walk: 'assets/A9YN2hiCuY.png',
    walk2: 'assets/BxhqoNBsy9.png',
    walk3: 'assets/DInQE4sGfT.png',
    walk4: 'assets/k5L5nRvfAz.png',
    attack: 'assets/RPBVhIBi7V.png',
    attack2: 'assets/RPBVhIBi7V.png',
    hit: 'assets/A9YN2hiCuY.png',
    color: '#206040', glow: '#80e0a0', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#a0f0c0',
  },
  silver_knight_blue: {
    idle: 'assets/wLT8tzjGBp.png',
    walk: 'assets/wLT8tzjGBp.png',
    walk2: 'assets/YxXoXhdLmS.png',
    walk3: 'assets/cN3E5Nquah.png',
    walk4: 'assets/ci6rXRx8DG.png',
    attack: 'assets/OSap9erVl0.png',
    attack2: 'assets/QRytegQ1Oe.png',
    hit: 'assets/JIGsfqs5tQ.png',
    color: '#c0c0d8', glow: '#e0e8ff', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#f0f0ff',
  },
  temple_knight: {
    idle: 'assets/nPAX4om6CQ.png',
    walk: 'assets/nPAX4om6CQ.png',
    walk2: 'assets/72qwU65Xsa.png',
    walk3: 'assets/UNCvpUlZe3.png',
    walk4: 'assets/BG9V2u0zRc.png',
    attack: 'assets/IVxWqYtCFv.png',
    attack2: 'assets/9aJxLBlYSk.png',
    hit: 'assets/bSTo2dlMbK.png',
    color: '#d0c080', glow: '#ffe8a0', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#fff0c0',
  },
  shadow_assassin_blue: {
    idle: 'assets/cRVH78jrX4.png',
    walk: 'assets/cRVH78jrX4.png',
    walk2: 'assets/owA0PPIkhb.png',
    walk3: 'assets/rCn1Xg8QwR.png',
    walk4: 'assets/QO6k6TReK3.png',
    attack: 'assets/uiC3MCWbCM.png',
    attack2: 'assets/3E5L92SGX8.png',
    hit: 'assets/FEaYTU3HUH.png',
    color: '#202030', glow: '#6080c0', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#80a0e0',
  },
  poison_blade: {
    idle: 'assets/qRmnQyhsHF.png',
    walk: 'assets/qRmnQyhsHF.png',
    walk2: 'assets/IIMkBDTmaj.png',
    walk3: 'assets/RBtLFeKz3n.png',
    walk4: 'assets/StSWxwsuyL.png',
    attack: 'assets/uQMK2b8OQV.png',
    attack2: 'assets/DEI5Znr00s.png',
    hit: 'assets/mO6nx6RVMn.png',
    color: '#204020', glow: '#80d060', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#a0e080',
  },
  gargoyle: {
    idle: 'assets/Qz5xkyMung.png',
    walk: 'assets/Qz5xkyMung.png',
    walk2: 'assets/SiOQl1qSHv.png',
    walk3: 'assets/FXdRQ4zYcV.png',
    walk4: 'assets/kgBNXt4Xoo.png',
    attack: 'assets/vQNYtfo6e9.png',
    attack2: 'assets/gLa19G08zS.png',
    hit: 'assets/PABlGUtHZI.png',
    color: '#404050', glow: '#a0a0c0', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#c0c0d0',
  },
  werewolf: {
    idle: 'assets/GMxsqLaCGt.png',
    walk: 'assets/GMxsqLaCGt.png',
    walk2: 'assets/q3MAJiktJq.png',
    walk3: 'assets/P8x4odPP2g.png',
    walk4: 'assets/xipd7571LS.png',
    attack: 'assets/qaasdrxeR4.png',
    attack2: 'assets/Z3K4JEOsj7.png',
    hit: 'assets/khEwYymEiA.png',
  ...
  // ---------- 綠色精良（新變身） ----------
  forest_guardian: {
    idle: 'assets/1daCVmkSeg.png',
    walk: 'assets/1daCVmkSeg.png',
    walk2: 'assets/7rkggQtVva.png',
    walk3: 'assets/7EMmttpXtt.png',
    walk4: 'assets/rUD0POkJta.png',
    attack: 'assets/rFGDkDOZRB.png',
    attack2: 'assets/0yfRk9msfe.png',
    hit: 'assets/u8C4FDxAzq.png',
    color: '#205030', glow: '#60c080', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#80e0a0',
  },
  wind_spirit: {
    idle: 'assets/jkm5kDZZyi.png',
    walk: 'assets/jkm5kDZZyi.png',
    walk2: 'assets/s1b9NsVUNP.png',
    walk3: 'assets/rY6t9P8rRQ.png',
    walk4: 'assets/u5eemtHJJk.png',
    attack: 'assets/Vn6NQ5HTfP.png',
    attack2: 'assets/C3VstdT6dQ.png',
    hit: 'assets/n7NjzUEXzg.png',
    color: '#80c0c0', glow: '#c0f0f0', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#e0ffff',
  },
  green_dragon: {
    idle: 'assets/Pl4PBEqsvs.png',
    walk: 'assets/Pl4PBEqsvs.png',
    walk2: 'assets/CH3Wf8rqcv.png',
    walk3: 'assets/324delxMNK.png',
    walk4: 'assets/jsmfG7UE6X.png',
    attack: 'assets/StVW9D5cG3.png',
    attack2: 'assets/KGGg348qE0.png',
    hit: 'assets/lyhUAf9LY1.png',
    color: '#204020', glow: '#80d060', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#a0e080',
  },
  druid: {
    idle: 'assets/g5u2Sq5agH.png',
    walk: 'assets/g5u2Sq5agH.png',
    walk2: 'assets/8uoto9Z1wj.png',
    walk3: 'assets/y1G12v4mDa.png',
    walk4: 'assets/3eq3rAYEYV.png',
    attack: 'assets/pFJT2Xc5o8.png',
    attack2: 'assets/Qd4BJClvxa.png',
    hit: 'assets/UdeJSiOwgC.png',
    color: '#405020', glow: '#a0c060', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#c0e080',
  },
  treant: {
    idle: 'assets/BIuGGAsYZh.png',
    walk: 'assets/BIuGGAsYZh.png',
    walk2: 'assets/vlURIemaSk.png',
    walk3: 'assets/GI7RvSykGX.png',
    walk4: 'assets/RqzkY6gSAe.png',
    attack: 'assets/q2rm4wKK3M.png',
    attack2: 'assets/F6ctRUeEtA.png',
    hit: 'assets/fNqR5LHWx6.png',
  ...
  // ---------- 白色普通（新變身） ----------
  white_dragon: {
    idle: 'assets/APDWUGWZVw.png',
    walk: 'assets/APDWUGWZVw.png',
    walk2: 'assets/bYD7aJdZCZ.png',
    walk3: 'assets/EHH32Fvnw1.png',
    walk4: 'assets/01wfNPiTXP.png',
    attack: 'assets/PL5FOn3oK3.png',
    attack2: 'assets/UfxwzeARpf.png',
    hit: 'assets/UIynvopITS.png',
    color: '#e0e8f0', glow: '#ffffff', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#ffffff',
  },
  angel_white: {
    idle: 'assets/NaPbNp9c1V.png',
    walk: 'assets/NaPbNp9c1V.png',
    walk2: 'assets/GUlp5Qy6iw.png',
    walk3: 'assets/5UMFE65Hny.png',
    walk4: 'assets/hbuS4nnQI2.png',
    attack: 'assets/0UZceLNR6V.png',
    attack2: 'assets/kUFVQVjTCS.png',
    hit: 'assets/3ygE66VdLj.png',
    color: '#f0f0e8', glow: '#fff8c0', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#ffffff',
  },
  unicorn: {
    idle: 'assets/a8JCQmVVNT.png',
    walk: 'assets/a8JCQmVVNT.png',
    walk2: 'assets/f8JFmtkifj.png',
    walk3: 'assets/8dvXmhS5c7.png',
    walk4: 'assets/HzkkhZbJQy.png',
    attack: 'assets/FOIte0Nrnl.png',
    attack2: 'assets/2lE46ur5Jl.png',
    hit: 'assets/1OVUePiezR.png',
    color: '#f8f0f8', glow: '#ffe0ff', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#ffffff',
  },
  holy_spirit: {
    idle: 'assets/TLuUdtTRPo.png',
    walk: 'assets/TLuUdtTRPo.png',
    walk2: 'assets/JcezH6rVhY.png',
    walk3: 'assets/gnxhj1r7Tr.png',
    walk4: 'assets/8IDPqcesFo.png',
    attack: 'assets/aNWVrFpkQ7.png',
    attack2: 'assets/DGdNzHjEpE.png',
    hit: 'assets/wZ2LHv5DEE.png',
    color: '#e8f0f8', glow: '#c0e0ff', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#f0f8ff',
  },
  white_wolf: {
    idle: 'assets/dPBulifvdn.png',
    walk: 'assets/dPBulifvdn.png',
    walk2: 'assets/vtUUJB7bTi.png',
    walk3: 'assets/Atwxnpfckc.png',
    walk4: 'assets/ysMOfAVZc0.png',
    attack: 'assets/tjFKwAE5pk.png',
    attack2: 'assets/ekiTVHnUBx.png',
    hit: 'assets/ohKPiheUuX.png',
  ...
  // ========== 怪物 ==========
  goblin: {
    idle: 'assets/wYFHmKE2C0.png',
    walk: 'assets/wYFHmKE2C0.png',
    walk2: 'assets/UG1LXPgLYT.png',
    walk3: 'assets/FVLNAE1Aju.png',
    walk4: 'assets/nGscTgMw4F.png',
    attack: 'assets/qN3FcGwEbv.png',
    attack2: 'assets/ic8EWNDNYs.png',
    hit: 'assets/WpaQwxUXzh.png',
    color: '#508040', glow: '#80c060', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#c0ff80',
  },
  skeleton: {
    idle: 'assets/Wzi9iVLdb2.png',
    walk: 'assets/Wzi9iVLdb2.png',
    walk2: 'assets/U9ed5silDc.png',
    walk3: 'assets/wpc6V9qVDO.png',
    walk4: 'assets/1x1j3NjhPH.png',
    attack: 'assets/VfGgZRdHIL.png',
    attack2: 'assets/YQCgkX79ZB.png',
    hit: 'assets/6ifL3DgjCY.png',
    color: '#e0e0d0', glow: '#ffffff', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#e0f0ff',
  },
  orc: {
    idle: 'assets/7jZBWui3Db.png',
    walk: 'assets/7jZBWui3Db.png',
    walk2: 'assets/Zpc82edK6V.png',
    walk3: 'assets/CewMfMo7tU.png',
    walk4: 'assets/9Us5kQk4ie.png',
    attack: 'assets/rvAT3NSnQB.png',
    attack2: 'assets/5oTzfOrfzV.png',
    hit: 'assets/Xc1HGJ1KGV.png',
    color: '#608040', glow: '#a0c060', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#d0ffa0',
  },
  slime: {
    idle: 'assets/582Ij09o3K.png',
    walk: 'assets/582Ij09o3K.png',
    walk2: 'assets/hjTKkz0REl.png',
    walk3: 'assets/uUcl6ZXFlt.png',
    walk4: 'assets/naY3bow36j.png',
    attack: 'assets/Wi8i3HuMPN.png',
    attack2: 'assets/xWZWQAzLLU.png',
    hit: 'assets/ULQRvB1CdS.png',
    color: '#40a060', glow: '#80e0a0', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#a0ffc0',
  },
  spider: {
    idle: 'assets/6AohjTIRnR.png',
    walk: 'assets/6AohjTIRnR.png',
    walk2: 'assets/AKCLMYp49L.png',
    walk3: 'assets/2hMO5hilVu.png',
    walk4: 'assets/L5TZ5ntmcZ.png',
    attack: 'assets/P4IKJKFaPb.png',
    attack2: 'assets/jrdjr24uAs.png',
    hit: 'assets/IkB3kC0MLn.png',
  ...
  demon: {
    idle: 'assets/ennzdff10h.png',
    walk: 'assets/ennzdff10h.png',
    walk2: 'assets/HHYnZL77dr.png',
    walk3: 'assets/iA3sODRZZ1.png',
    walk4: 'assets/iovh4nWNY3.png',
    attack: 'assets/VvBW6MiFDv.png',
    attack2: 'assets/GCjQ9UYJCa.png',
    hit: 'assets/bOvayC2iOD.png',
  ...
  // 中高階怪物 8 帧
  ogre: {
    idle: 'assets/6mcEV2Pgpy.png',
    walk: 'assets/6mcEV2Pgpy.png',
    walk2: 'assets/OlcaeodfWk.png',
    walk3: 'assets/EfvFkRDFHo.png',
    walk4: 'assets/8s0noOL4Yj.png',
    attack: 'assets/WV9nboUyMl.png',
    attack2: 'assets/YY8fAAd1go.png',
    hit: 'assets/5vqHZHGQV5.png',
    color: '#806040', glow: '#d0a060', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#ffb060',
  },
  lizardman: {
    idle: 'assets/TCEkPooI9E.png',
    walk: 'assets/TCEkPooI9E.png',
    walk2: 'assets/S4gNP4k3pT.png',
    walk3: 'assets/AY9mkXA71v.png',
    walk4: 'assets/HLDhc9wPmh.png',
    attack: 'assets/w9OpsvrH9Z.png',
    attack2: 'assets/3iG0uaSQjw.png',
    hit: 'assets/rmIJxJ5Fpg.png',
    color: '#40a060', glow: '#80e0a0', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#a0ffc0',
  },
  stone_golem: {
    idle: 'assets/1djiUtrb2c.png',
    walk: 'assets/1djiUtrb2c.png',
    walk2: 'assets/znvzkueF2c.png',
    walk3: 'assets/Ix5C2VbmyJ.png',
    walk4: 'assets/pVW3CEoidZ.png',
    attack: 'assets/38FuwV7gPw.png',
    attack2: 'assets/BUQtrrYRAS.png',
    hit: 'assets/paWYrtkpSB.png',
    color: '#908070', glow: '#c0b0a0', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#e0d0b0',
  },
  lich: {
    idle: 'assets/DKPorAcX7s.png',
    walk: 'assets/DKPorAcX7s.png',
    walk2: 'assets/RiirQZ3fSV.png',
    walk3: 'assets/MuVRCBrUzD.png',
    walk4: 'assets/iQg6zyogEa.png',
    attack: 'assets/JspSNdIB2O.png',
    attack2: 'assets/A2ZjoB2Pki.png',
    hit: 'assets/OgVGjrT6k0.png',
    color: '#8040a0', glow: '#c080e0', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#e0a0ff',
  },
  cerberus: {
    idle: 'assets/F8IHeapTW8.png',
    walk: 'assets/F8IHeapTW8.png',
    walk2: 'assets/jCmgvBVpIR.png',
    walk3: 'assets/hLV7TMIaDa.png',
    walk4: 'assets/88U5UCP6GP.png',
    attack: 'assets/GfUTUL5jbI.png',
    attack2: 'assets/En7HDFOJVa.png',
    hit: 'assets/QdZmXT0MUR.png',
  ...
  // ========== 新增 8 帧怪物 ==========
  monster_hellhound: {
    idle: 'assets/QVsxMC7AXE.png',
    walk: 'assets/QVsxMC7AXE.png',
    walk2: 'assets/Y7D6wor5GO.png',
    walk3: 'assets/h1SdH2HSwb.png',
    walk4: 'assets/HtY7WUwH6y.png',
    attack: 'assets/NckDHIlVdY.png',
    attack2: 'assets/RCqUWJ5gFx.png',
    hit: 'assets/Vb5KUo6sqn.png',
    color: '#301010', glow: '#ff4020', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#ff8040',
  },
  monster_braindevil: {
    idle: 'assets/sxV2RI2KMa.png',
    walk: 'assets/sxV2RI2KMa.png',
    walk2: 'assets/L2OBUHNdsg.png',
    walk3: 'assets/GzLoOexBtC.png',
    walk4: 'assets/VSwDVeboki.png',
    attack: 'assets/HjiPNansZJ.png',
    attack2: 'assets/FRwIj4bM49.png',
    hit: 'assets/b3NpFiK4gt.png',
    color: '#8040a0', glow: '#d080ff', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#e0a0ff',
  },
  monster_direwolf: {
    idle: 'assets/ZUTg8LaVx4.png',
    walk: 'assets/ZUTg8LaVx4.png',
    walk2: 'assets/nbtEFlg5Ee.png',
    walk3: 'assets/UjIVNyA3ms.png',
    walk4: 'assets/f7yZo8ohJK.png',
    attack: 'assets/1PRvT0IyUa.png',
    attack2: 'assets/VudULCUxHn.png',
    hit: 'assets/UKCZ9Ol81J.png',
    color: '#504030', glow: '#c0a060', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#ffc060',
  },
  monster_scorpion: {
    idle: 'assets/clSORpgY8H.png',
    walk: 'assets/clSORpgY8H.png',
    walk2: 'assets/OQ155a7UgC.png',
    walk3: 'assets/0qJFdwQwIA.png',
    walk4: 'assets/GNZH2vsocJ.png',
    attack: 'assets/UgIpBy6CPb.png',
    attack2: 'assets/L8URoUC8Vs.png',
    hit: 'assets/9evfx7AVO8.png',
    color: '#a06020', glow: '#ff9040', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#ffb060',
  },
  monster_wraith: {
    idle: 'assets/ZhVGRF6Vtp.png',
    walk: 'assets/ZhVGRF6Vtp.png',
    walk2: 'assets/oLc2Dzb4Gp.png',
    walk3: 'assets/pHCtLwxDf4.png',
    walk4: 'assets/2UqZ9EqS9X.png',
    attack: 'assets/ArU5iZorxO.png',
    attack2: 'assets/tuLEUDjxSt.png',
    hit: 'assets/CFc9nu0uVZ.png',
    color: '#302040', glow: '#8060c0', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#a080ff',
  },
  monster_gargoyle: {
    idle: 'assets/WFSp2Ctj4D.png',
    walk: 'assets/WFSp2Ctj4D.png',
    walk2: 'assets/i5XYfgjPDQ.png',
    walk3: 'assets/nqRRU8MWNQ.png',
    walk4: 'assets/UwvHjx0urh.png',
    attack: 'assets/ndPzwGiddo.png',
    attack2: 'assets/xmJHo2FGR6.png',
    hit: 'assets/VbAUPUjQRw.png',
  ...
  // ========== 新增變身 8 帧 ==========
  tf_demonlord: {
    idle: 'assets/88a59LdSSj.png',
    walk: 'assets/88a59LdSSj.png',
    walk2: 'assets/VQVnYOGqI0.png',
    walk3: 'assets/dfYQSwdbFC.png',
    walk4: 'assets/4rskJ0uzUP.png',
    attack: 'assets/3CxLgjYu06.png',
    attack2: 'assets/4dWxcP34zc.png',
    hit: 'assets/yVyGfGb920.png',
    color: '#501020', glow: '#ff4060', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#ff8060',
  },
  tf_frostgiant: {
    idle: 'assets/VcqQUDirUp.png',
    walk: 'assets/VcqQUDirUp.png',
    walk2: 'assets/AlSTOhTlsh.png',
    walk3: 'assets/oAK5BfqbUG.png',
    walk4: 'assets/w3wSWVILVJ.png',
    attack: 'assets/GyUzsLGZl9.png',
    attack2: 'assets/9HVEwc1CHV.png',
    hit: 'assets/WEmjqc7EFZ.png',
    color: '#4060a0', glow: '#80c0ff', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#a0e0ff',
  },
  // ========== 新增英雄 8 帧 ==========
  hero_phoenix: {
    idle: 'assets/vASAOufnxz.png',
    walk: 'assets/vASAOufnxz.png',
    walk2: 'assets/RWwbIlt65D.png',
    walk3: 'assets/be2uP8VYpR.png',
    walk4: 'assets/GcUyuA4fDo.png',
    attack: 'assets/7cS3BR2aXs.png',
    attack2: 'assets/8Oi9kqjlW7.png',
    hit: 'assets/4trwK4nbCK.png',
    color: '#a02020', glow: '#ff6030', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#ffb040',
  },
  hero_treant: {
    idle: 'assets/kRG3SukyKD.png',
    walk: 'assets/kRG3SukyKD.png',
    walk2: 'assets/h456EaLNMu.png',
    walk3: 'assets/DN7Jyx82Wy.png',
    walk4: 'assets/ohQfz22Mtr.png',
    attack: 'assets/QfMFFvqiVJ.png',
    attack2: 'assets/Ss1BU5oAYq.png',
    hit: 'assets/VtD3SeV87P.png',
    color: '#406030', glow: '#80c060', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#a0e080',
  },
  // ========== 新增守護寵物 8 帧 ==========
  pet_babydragon: {
    idle: 'assets/Dkfsh1CEdZ.png',
    walk: 'assets/Dkfsh1CEdZ.png',
    walk2: 'assets/ZPb3OZuZEL.png',
    walk3: 'assets/8JtMbrXzkC.png',
    walk4: 'assets/eZAsyoTZ9W.png',
    attack: 'assets/v6ULhArJGa.png',
    attack2: 'assets/4jlfLOErYV.png',
    hit: 'assets/8lYZtkJWBq.png',
    color: '#c06020', glow: '#ffc040', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#ff8040',
  },
  pet_wisp: {
    idle: 'assets/uIJL48AKFZ.png',
    walk: 'assets/uIJL48AKFZ.png',
    walk2: 'assets/YW2kaD9BPQ.png',
    walk3: 'assets/ef7VCkv4js.png',
    walk4: 'assets/bGksllK8MX.png',
    attack: 'assets/6QwiEOkRqz.png',
    attack2: 'assets/vCWDKFq6g3.png',
    hit: 'assets/iYmy5Ot2bc.png',
    color: '#4080c0', glow: '#80e0ff', useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#a0d0ff',
  },
  dragon: {
  ...
  boss_dragon: {
    idle: 'assets/o1qWUrCATh.png',
    walk: 'assets/o1qWUrCATh.png',
    walk2: 'assets/g3Irrwx4oq.png',
    walk3: 'assets/jJaVDoXIZ2.png',
    walk4: 'assets/CnUAPsRzlA.png',
    attack: 'assets/Fr4eqGqBd6.png',
    attack2: 'assets/mXwLa8wNlS.png',
    hit: 'assets/1wgGAVd8JU.png',
    color: '#e09010', glow: '#ffc040', boss: true, useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#ffd060',
  },
  boss_death_knight: {
    idle: 'assets/7FnWRqmp3O.png',
    walk: 'assets/7FnWRqmp3O.png',
    walk2: 'assets/U8U8zD5mQY.png',
    walk3: 'assets/x0ngk7iSES.png',
    walk4: 'assets/aPOtgxIgss.png',
    attack: 'assets/KRVgdmZdqh.png',
    attack2: 'assets/B1oZEnBt4W.png',
    hit: 'assets/eqsOwvfx7E.png',
    color: '#404060', glow: '#8080c0', boss: true, useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#c0c0ff',
  },
  boss_baphomet: {
    idle: 'assets/B5UzjmgzgT.png',
    walk: 'assets/B5UzjmgzgT.png',
    walk2: 'assets/rCZVzIR4DM.png',
    walk3: 'assets/DsZs2wdjX8.png',
    walk4: 'assets/FvmW2tQuUr.png',
    attack: 'assets/fXcREvAk5H.png',
    attack2: 'assets/49gZhlUxoM.png',
    hit: 'assets/9aUL4o7j9K.png',
    color: '#602040', glow: '#ff5080', boss: true, useImg: true,
    multiFrame: true, coverMode: true,
    slashColor: '#ff80a0',
  },
  boss_demon_lord: {
    idle: 'assets/MQbYJyKtqK.png',
    walk: 'assets/MQbYJyKtqK.png',
    walk2: 'assets/daKfmMOKiL.png',
    walk3: 'assets/H0oH4yS5iQ.png',
    walk4: 'assets/HfzbqxNOUp.png',
    attack: 'assets/wltQkklEoZ.png',
    attack2: 'assets/OYdq2KLrpQ.png',
    hit: 'assets/7YUd2dOZDc.png',
  ...
  // ========== NPC 8 幀完整動畫 ==========
  npc_blacksmith: {
    idle: 'assets/dTOA2QKqa8.png',
    walk: 'assets/dTOA2QKqa8.png',
    walk2: 'assets/JiW0xwVu7J.png',
    walk3: 'assets/JUMDNgMWNh.png',
    walk4: 'assets/eNrCqbW21z.png',
    attack: 'assets/miiDBxtyiq.png',
    attack2: 'assets/839Tu3fbmo.png',
    hit: 'assets/joG7wQ5Okj.png',
    color: '#c08040', glow: '#ffc080', npc: true, useImg: true, multiFrame: true,
  },
  npc_shop: {
    idle: 'assets/PllNPKAjDG.png',
    walk: 'assets/PllNPKAjDG.png',
    walk2: 'assets/lX6cLQIs6s.png',
    walk3: 'assets/GhtUV9MoUM.png',
    walk4: 'assets/1pMUj0WrTL.png',
    attack: 'assets/oAdyWKiLsb.png',
    attack2: 'assets/i3hZlyVOEh.png',
    hit: 'assets/boDlZxOnVq.png',
    color: '#a08060', glow: '#d0b080', npc: true, useImg: true, multiFrame: true,
  },
  npc_luxury: {
    idle: 'assets/SzFME3Pi9q.png',
    walk: 'assets/SzFME3Pi9q.png',
    walk2: 'assets/GmJMM0gLrk.png',
    walk3: 'assets/2ZqpOZV4JY.png',
    walk4: 'assets/Vy3TpO90sn.png',
    attack: 'assets/KUmdX94cVK.png',
    attack2: 'assets/lcRLg7RtoR.png',
    hit: 'assets/nvZ2iSN7Wz.png',
    color: '#b080c0', glow: '#e0b0ff', npc: true, useImg: true, multiFrame: true,
  },
  npc_warehouse: {
    idle: 'assets/8UYlKPr8L4.png',
    walk: 'assets/8UYlKPr8L4.png',
    walk2: 'assets/VgfWfm7Wp3.png',
    walk3: 'assets/NPqYADvHxg.png',
    walk4: 'assets/Buiu25AfYt.png',
    attack: 'assets/YBZ4yf3Kz5.png',
    attack2: 'assets/BBZwu283Gy.png',
    hit: 'assets/1HbZreUQHQ.png',
    color: '#a08060', glow: '#d0b080', npc: true, useImg: true, multiFrame: true,
  },
  npc_quest: {
    idle: 'assets/Cv17QVXyT5.png',
    walk: 'assets/Cv17QVXyT5.png',
    walk2: 'assets/4srtvDjQPd.png',
    walk3: 'assets/UlhVkekfia.png',
    walk4: 'assets/B1Xj8KAEhe.png',
    attack: 'assets/IrrsDh0lJh.png',
    attack2: 'assets/oe0oox3tFe.png',
    hit: 'assets/ADErARCdEu.png',
    color: '#4080c0', glow: '#80b0ff', npc: true, useImg: true, multiFrame: true,
  },
  npc_inn: {
    idle: 'assets/9nqQW8OMjO.png',
    walk: 'assets/9nqQW8OMjO.png',
    walk2: 'assets/LAPpVgy0XL.png',
    walk3: 'assets/iXPfLZ7kDc.png',
    walk4: 'assets/ccwUb4KD6L.png',
    attack: 'assets/1LlR6vpGYg.png',
    attack2: 'assets/5m99bxAUW8.png',
    hit: 'assets/wQdrQVESaP.png',
  ...
  npc_dungeon: {
    idle: 'assets/WQcx9I9OBq.png',
    walk: 'assets/WQcx9I9OBq.png',
    walk2: 'assets/ZNvUhqSGHj.png',
    walk3: 'assets/kgmSkvojy6.png',
    walk4: 'assets/TjaUWFvn6f.png',
    attack: 'assets/T73arNQQlA.png',
    attack2: 'assets/N3ukZgdVoy.png',
    hit: 'assets/u8YESfQcD3.png',
  ...
  npc_guard: {
    idle: 'assets/TiXM8q4lZK.png',
    walk: 'assets/TiXM8q4lZK.png',
    walk2: 'assets/jjmrlmCWwC.png',
    walk3: 'assets/8UCc4uRd5e.png',
    walk4: 'assets/7x4aF7VXRK.png',
    attack: 'assets/s8UUkfmEvx.png',
    attack2: 'assets/qfwrYpaJ2K.png',
    hit: 'assets/YZXtVvdmuR.png',
  ...
  // ========== 新英雄 8 幀完整動畫 ==========
  hero_fire_elemental: {
    idle: 'assets/ScTVMscBly.png',
    walk: 'assets/ScTVMscBly.png',
    walk2: 'assets/CWImnq6w74.png',
    walk3: 'assets/eGFznrB3mT.png',
    walk4: 'assets/N9HEYzExfI.png',
    attack: 'assets/DGju3Q4Ork.png',
    attack2: 'assets/wF6kKJTc94.png',
    hit: 'assets/drRUJ1PiSv.png',
    color: '#ff6030', glow: '#ffb060', useImg: true, multiFrame: true,
  },
  hero_frost_wolf: {
    idle: 'assets/hvqAPvsE23.png',
    walk: 'assets/hvqAPvsE23.png',
    walk2: 'assets/crmYOmDoIP.png',
    walk3: 'assets/5F14d71Pyl.png',
    walk4: 'assets/wDBEVqyFld.png',
    attack: 'assets/UhCMU18cUM.png',
    attack2: 'assets/yPlesBoan0.png',
    hit: 'assets/G5YNj7nOuU.png',
    color: '#60b0ff', glow: '#a0d8ff', useImg: true, multiFrame: true,
  },
  hero_dark_beast: {
    idle: 'assets/l9oUjCLsvD.png',
    walk: 'assets/l9oUjCLsvD.png',
    walk2: 'assets/nO9v776UoV.png',
    walk3: 'assets/2znmT3dKQc.png',
    walk4: 'assets/r5SXmQVUv2.png',
    attack: 'assets/4GGzWY67AP.png',
    attack2: 'assets/XFdWB5oY1w.png',
    hit: 'assets/IiUR2GRnKz.png',
    color: '#6040a0', glow: '#a080e0', useImg: true, multiFrame: true,
  },
  hero_golden_griffin: {
    idle: 'assets/M8iLItb8SL.png',
    walk: 'assets/M8iLItb8SL.png',
    walk2: 'assets/emAq8UCONc.png',
    walk3: 'assets/fCC7qVivRp.png',
    walk4: 'assets/TAQamR2aH5.png',
    attack: 'assets/3p1uOOFmcV.png',
    attack2: 'assets/MouZcszF2k.png',
    hit: 'assets/Ndq0gap6Nr.png',
    color: '#ffd040', glow: '#fff0a0', useImg: true, multiFrame: true,
  },
  hero_undead_knight: {
    idle: 'assets/Zae7N0mwUb.png',
    walk: 'assets/Zae7N0mwUb.png',
    walk2: 'assets/pI0sXZsd8V.png',
    walk3: 'assets/P5Zx8qWbOU.png',
    walk4: 'assets/khiUoUYZ0t.png',
    attack: 'assets/FdRbs6DDqD.png',
    attack2: 'assets/wxUDxrtuLx.png',
    hit: 'assets/oJot2AXiYN.png',
    color: '#a080d0', glow: '#d0b0ff', useImg: true, multiFrame: true,
  },
  hero_thunder_bear: {
    idle: 'assets/Pq2UOQqKkD.png',
    walk: 'assets/Pq2UOQqKkD.png',
    walk2: 'assets/nYr4vtlMDr.png',
    walk3: 'assets/RfAz4VpN1S.png',
    walk4: 'assets/T9M88GBCQk.png',
    attack: 'assets/jHVVvaUxZ2.png',
    attack2: 'assets/Td3MQT1tnF.png',
    hit: 'assets/U8qQhdSmbz.png',
    color: '#ffcc30', glow: '#ffee90', useImg: true, multiFrame: true,
  },
  hero_demoness: {
    idle: 'assets/WawynjOGZK.png',
    walk: 'assets/WawynjOGZK.png',
    walk2: 'assets/dxmuWjHkBl.png',
    walk3: 'assets/zfpTV9oMHP.png',
    walk4: 'assets/x9J654XZVH.png',
    attack: 'assets/paP684cHRG.png',
    attack2: 'assets/znpkGtJ8yR.png',
    hit: 'assets/oUwn28Nr9n.png',
    color: '#ff60a0', glow: '#ffa0d0', useImg: true, multiFrame: true,
  },
  hero_stone_titan: {
    idle: 'assets/I2SNzCU0xy.png',
    walk: 'assets/I2SNzCU0xy.png',
    walk2: 'assets/zV8GhUB4Mx.png',
    walk3: 'assets/YjCgRDLbqB.png',
    walk4: 'assets/MVfdatmvBN.png',
    attack: 'assets/axD7UXXItT.png',
    attack2: 'assets/XrPTYEU4do.png',
    hit: 'assets/Upf0cg83SP.png',
  ...
  // ========== 新寵物 8 幀完整動畫 ==========
  pet_imp: {
    idle: 'assets/VNXoKs3gVe.png',
    walk: 'assets/VNXoKs3gVe.png',
    walk2: 'assets/8eUdSO7p1X.png',
    walk3: 'assets/QgfE2yaV9i.png',
    walk4: 'assets/UeNX99JezO.png',
    attack: 'assets/aNnoxlZvqy.png',
    attack2: 'assets/1kRVSk3VBo.png',
    hit: 'assets/vm7NU2YYU2.png',
    color: '#ff8040', glow: '#ffb060', useImg: true, multiFrame: true,
  },
  pet_fairy_new: {
    idle: 'assets/nhyoVvTDFa.png',
    walk: 'assets/nhyoVvTDFa.png',
    walk2: 'assets/OUOgvHV162.png',
    walk3: 'assets/OS4DgGfxDX.png',
    walk4: 'assets/UqBOwVpHVD.png',
    attack: 'assets/gCnLxoD4bF.png',
    attack2: 'assets/ZA02HOMe9o.png',
    hit: 'assets/eGsb5rxWyJ.png',
    color: '#a0e0ff', glow: '#d0f0ff', useImg: true, multiFrame: true,
  },
  pet_witch_cat: {
    idle: 'assets/QozCIYqTi6.png',
    walk: 'assets/QozCIYqTi6.png',
    walk2: 'assets/riDC4w2gn5.png',
    walk3: 'assets/B3Q2VfQ2ma.png',
    walk4: 'assets/34LTJLiNDO.png',
    attack: 'assets/HSeduXVKKS.png',
    attack2: 'assets/sDUTc8rRsH.png',
    hit: 'assets/ywIBCICmss.png',
    color: '#a060e0', glow: '#c090ff', useImg: true, multiFrame: true,
  },
  pet_fire_lizard: {
    idle: 'assets/3x3U48gZcR.png',
    walk: 'assets/3x3U48gZcR.png',
    walk2: 'assets/ZMuQtC5AnB.png',
    walk3: 'assets/LDFdRSGLLU.png',
    walk4: 'assets/9uCZT7XwV6.png',
    attack: 'assets/Y0gKbBMsH0.png',
    attack2: 'assets/KGHuzfmA1U.png',
    hit: 'assets/hniEKvAlCO.png',
    color: '#ff5030', glow: '#ff9060', useImg: true, multiFrame: true,
  },
  pet_ice_sprite: {
    idle: 'assets/bOtwklpRMp.png',
    walk: 'assets/bOtwklpRMp.png',
    walk2: 'assets/1pdxAdoLkk.png',
    walk3: 'assets/t14WAYneux.png',
    walk4: 'assets/fIErMbleyT.png',
    attack: 'assets/6t4fhS2Rnk.png',
    attack2: 'assets/0n0OP8HGwG.png',
    hit: 'assets/OPGnviaSwV.png',
    color: '#60c0ff', glow: '#a0e0ff', useImg: true, multiFrame: true,
  },
  pet_ghost_new: {
    idle: 'assets/rs4Pd5hKUV.png',
    walk: 'assets/rs4Pd5hKUV.png',
    walk2: 'assets/tVfIA7pfL5.png',
    walk3: 'assets/vOdqBdV8SH.png',
    walk4: 'assets/HqrXEGComg.png',
    attack: 'assets/RDeqjGT7Vb.png',
    attack2: 'assets/Hs525wcDUn.png',
    hit: 'assets/CHsc86xPbU.png',
    color: '#c0c0e0', glow: '#e0e0ff', useImg: true, multiFrame: true,
  },
  pet_golden_whelp: {
    idle: 'assets/0JFrRSWgEf.png',
    walk: 'assets/0JFrRSWgEf.png',
    walk2: 'assets/g7KBkTkxXR.png',
    walk3: 'assets/7eH9UKyXCD.png',
    walk4: 'assets/l8FG4zID55.png',
    attack: 'assets/8vBBDoZ9zt.png',
    attack2: 'assets/mbRbnIs048.png',
    hit: 'assets/7A7eCh99EZ.png',
    color: '#ffd040', glow: '#ffee80', useImg: true, multiFrame: true,
  },
  pet_shadow_serpent: {
    idle: 'assets/5chTx1jae1.png',
    walk: 'assets/5chTx1jae1.png',
    walk2: 'assets/5pLySnK3Lg.png',
    walk3: 'assets/luJgikxm9M.png',
    walk4: 'assets/A21pYqojQe.png',
    attack: 'assets/fZ8bgNFydU.png',
    attack2: 'assets/7PqulR5l5h.png',
    hit: 'assets/bms44tYXFo.png',
...
const SAFE_MAPS = {
  village: {
    ...
    bg: MAP_BG_VILLAGE,
    npcs: [
      { id: 'blacksmith',     name: '鐵匠',        x: 180,  y: 700 },  // 左側鐵匠鋪
      { id: 'shop',           name: '雜貨商人',    x: 420,  y: 660 },  // 中央雜貨店
      { id: 'warehouse',      name: '倉庫管理員',  x: 300,  y: 860 },  // 左下倉庫
      { id: 'inn',            name: '旅館老闆娘',  x: 600,  y: 800 },  // 中央偏右旅館
      { id: 'bulletin',       name: '佈告欄',      x: 760,  y: 680 },  // 右側佈告欄
      { id: 'quest',          name: '任務官',      x: 900,  y: 740, quest: true },  // 東側任務所
      { id: 'dungeon_master', name: '副本管理員',  x: 1120, y: 780 },  // 最東副本入口
      { id: 'premium_shop',   name: '高級商人',    x: 980,  y: 880 },  // 東南高級商店
      { id: 'main_quest',     name: '大祭司',      x: 680,  y: 900, quest: true, mainQuest: true },  // 南邊神殿
      { id: 'guard',          name: '村莊警衛',    x: 140,  y: 600 },  // 西北門警衛
      { id: 'guard',          name: '村莊警衛',    x: 1160, y: 600 },  // 東北門警衛
      { id: 'guard',          name: '村莊警衛',    x: 560,  y: 560 },  // 中央廣場警衛
    ],
  ...
  forest_village: {
    ...
    bg: MAP_BG_ELF,
    npcs: [
      { id: 'shop',           name: '雜貨商人',   x: 220,  y: 680 },
      { id: 'blacksmith',     name: '精靈鐵匠',   x: 1020, y: 720 },
      { id: 'warehouse',      name: '倉庫管理員', x: 360,  y: 860 },
      { id: 'inn',            name: '樹屋旅館',   x: 560,  y: 740 },
      { id: 'bulletin',       name: '佈告欄',     x: 720,  y: 680 },
      { id: 'quest',          name: '精靈長老',   x: 860,  y: 800, quest: true },
      { id: 'dungeon_master', name: '森林嚮導',   x: 1140, y: 860 },
      { id: 'premium_shop',   name: '高級商人',   x: 940,  y: 900 },
      { id: 'main_quest',     name: '長老議員',   x: 640,  y: 920, quest: true, mainQuest: true },
      { id: 'guard',          name: '精靈哨兵',   x: 180,  y: 620 },
      { id: 'guard',          name: '精靈哨兵',   x: 1100, y: 640 },
    ],
  ...
  graveyard_village: {
    ...
    npcs: [
      { id: 'shop',           name: '補給商人',   x: 220,  y: 740 },
      { id: 'blacksmith',     name: '鐵匠',       x: 960,  y: 740 },
      { id: 'warehouse',      name: '倉庫管理員', x: 400,  y: 880 },
      { id: 'inn',            name: '破舊旅館',   x: 580,  y: 800 },
      { id: 'bulletin',       name: '佈告欄',     x: 740,  y: 720 },
      { id: 'quest',          name: '守墓人',     x: 860,  y: 840, quest: true },
      { id: 'dungeon_master', name: '墓地守護者', x: 1100, y: 900 },
      { id: 'premium_shop',   name: '高級商人',   x: 1000, y: 760 },
      { id: 'main_quest',     name: '亡靈法師',   x: 500,  y: 720, quest: true, mainQuest: true },
      { id: 'guard',          name: '驅魔衛兵',   x: 260,  y: 660 },
      { id: 'guard',          name: '驅魔衛兵',   x: 1060, y: 680 },
    ],
  ...
  desert_village: {
    ...
    npcs: [
      { id: 'shop',           name: '沙漠商人',   x: 240,  y: 760 },
      { id: 'blacksmith',     name: '鐵匠',       x: 980,  y: 720 },
      { id: 'warehouse',      name: '駱駝管理員', x: 420,  y: 880 },
      { id: 'inn',            name: '綠洲旅館',   x: 600,  y: 800 },
      { id: 'bulletin',       name: '佈告欄',     x: 760,  y: 740 },
      { id: 'quest',          name: '商隊隊長',   x: 880,  y: 860, quest: true },
      { id: 'dungeon_master', name: '副本管理員', x: 1120, y: 800 },
      { id: 'premium_shop',   name: '高級珠寶商', x: 1040, y: 900 },
      { id: 'main_quest',     name: '沙漠先知',   x: 540,  y: 920, quest: true, mainQuest: true },
      { id: 'guard',          name: '绿洲衛隊',   x: 200,  y: 680 },
      { id: 'guard',          name: '绿洲衛隊',   x: 1080, y: 660 },
    ],
  ...
  cave_village: {
    ...
    bg: MAP_BG_DARKFOREST,
    npcs: [
      { id: 'shop',           name: '補給官',     x: 200,  y: 740 },
      { id: 'blacksmith',     name: '鐵匠',       x: 960,  y: 760 },
      { id: 'warehouse',      name: '倉庫管理員', x: 380,  y: 880 },
      { id: 'inn',            name: '前哨營地',   x: 520,  y: 780 },
      { id: 'bulletin',       name: '佈告欄',     x: 700,  y: 720 },
      { id: 'quest',          name: '冒險團長',   x: 820,  y: 840, quest: true },
      { id: 'dungeon_master', name: '洞窟導遊',   x: 1080, y: 860 },
      { id: 'premium_shop',   name: '高級裝備商', x: 940,  y: 900 },
      { id: 'main_quest',     name: '遠古守護者', x: 620,  y: 920, quest: true, mainQuest: true },
      { id: 'guard',          name: '前哨衛兵',   x: 240,  y: 660 },
      { id: 'guard',          name: '前哨衛兵',   x: 1060, y: 680 },
    ],
...
const BATTLE_MAPS = {
  ...
  dark_forest: {
    ...
    monsters: [
      ...
      { type: 'lizardman', name: '森林蜥蜴人', level: 14, count: 6 },
      { type: 'goblin', name: '森林哥布林長', level: 11, count: 4 },
    ],
    boss: { type: 'lizardman', name: '蜥蜴人酋長', level: 20, hpMult: 10, atkMult: 2.5, respawn: 1800, x: 1900, y: 700, tier: 'normal' },
  },
  graveyard: {
    ...
    monsters: [
      ...
      { type: 'lizardman', name: '沼澤蜥蜴人', level: 22, count: 7 },
      { type: 'skeleton', name: '亡灵骑士', level: 28, count: 6 },
      { type: 'ogre', name: '食人魔', level: 25, count: 6 },
      { type: 'ogre', name: '食人魔狂战士', level: 30, count: 4 },
      { type: 'monster_direwolf', name: '巨狼', level: 28, count: 5 },
    ],
    boss: { type: 'ogre', name: '食人魔領主', level: 35, hpMult: 12, atkMult: 3, respawn: 2700, x: 1850, y: 650, tier: 'normal' },
  },
  red_desert: {
    ...
    monsters: [
      ...
      { type: 'stone_golem', name: '砂岩魔像', level: 38, count: 6 },
      { type: 'ogre', name: '沙漠食人魔', level: 40, count: 5 },
      { type: 'lizardman', name: '沙漠蜥蜴人', level: 36, count: 6 },
      { type: 'stone_golem', name: '巨型石魔像', level: 45, count: 4 },
      { type: 'monster_scorpion', name: '毒蝎', level: 38, count: 5 },
      { type: 'monster_hellhound', name: '地獄犬', level: 45, count: 4 },
      { type: 'monster_direwolf', name: '沙漠巨狼', level: 32, count: 5 },
    ],
    boss: { type: 'stone_golem', name: '沙漠守護者', level: 55, hpMult: 15, atkMult: 3.5, respawn: 3600, x: 2000, y: 750, tier: 'advanced' },
  },
  dark_cave: {
    id: 'dark_cave', name: '幽暗洞窟', type: 'battle',
    bg: MAP_BG_DARKFOREST,
    levelMin: 50, levelMax: 70, nearVillage: 'cave_village', castle: 'aden',
    monsters: [
      { type: 'demon', name: '低階惡魔', level: 55, count: 8 },
      { type: 'stone_golem', name: '黑曜魔像', level: 60, count: 7 },
      { type: 'lich', name: '亡靈法師', level: 58, count: 6 },
      { type: 'cerberus', name: '地獄犬', level: 62, count: 5 },
      { type: 'demon', name: '惡魔衛士', level: 65, count: 6 },
      { type: 'cerberus', name: '雙頭地獄犬', level: 68, count: 4 },
      { type: 'monster_hellhound', name: '深淵地獄犬', level: 52, count: 5 },
      { type: 'monster_braindevil', name: '腦魔', level: 58, count: 4 },
      { type: 'monster_gargoyle', name: '石像鬼', level: 58, count: 4, behavior: 'passive' },
      { type: 'monster_wraith', name: '暗影幽魂', level: 65, count: 4, behavior: 'aggro' },
    ],
    boss: { type: 'death_knight', name: '死亡騎士', level: 70, hpMult: 22, atkMult: 4.5, respawn: 5400, x: 2100, y: 800, tier: 'advanced' },
  },
  dragon_lair: {
    id: 'dragon_lair', name: '巨龍巢穴', type: 'battle',
    bg: MAP_BG_DEADDESERT,
    levelMin: 65, levelMax: 80, nearVillage: 'cave_village', castle: 'aden',
    monsters: [
      { type: 'stone_golem', name: '龍穴守衛', level: 68, count: 6 },
      { type: 'demon', name: '龍族僕從', level: 72, count: 6 },
      { type: 'cerberus', name: '火炎地獄犬', level: 70, count: 5 },
      { type: 'lich', name: '龍語巫妖', level: 75, count: 4 },
      { type: 'ogre', name: '巨龍奴隸', level: 66, count: 5 },
    ],
    boss: { type: 'dragon', name: '遠古巨龍', level: 80, hpMult: 28, atkMult: 5, respawn: 7200, x: 2100, y: 750, tier: 'world' },
  },
  demon_abyss: {
    id: 'demon_abyss', name: '魔界深淵', type: 'battle',
    bg: MAP_BG_DARKFOREST,
    levelMin: 75, levelMax: 90, nearVillage: 'cave_village', castle: 'aden',
    monsters: [
      { type: 'demon', name: '深淵惡魔', level: 78, count: 7 },
      { type: 'cerberus', name: '深淵守衛犬', level: 75, count: 6 },
      { type: 'lich', name: '深淵巫妖', level: 80, count: 5 },
      { type: 'demon', name: '惡魔領主', level: 82, count: 4 },
      { type: 'stone_golem', name: '煉獄魔像', level: 76, count: 5 },
    ],
    boss: { type: 'baphomet', name: '巴風特', level: 85, hpMult: 32, atkMult: 5.5, respawn: 10800, x: 2100, y: 780, tier: 'world' },
    worldBoss: { type: 'demon_lord', name: '魔王', level: 90, hpMult: 50, atkMult: 7, respawn: 21600, x: 2000, y: 700, tier: 'final' },
  },
};
...
const MONSTER_SPRITES = {
  ...
  ogre:    SPRITE.ogre,
  lizardman: SPRITE.lizardman,
  stone_golem: SPRITE.stone_golem,
  lich:    SPRITE.lich,
  cerberus: SPRITE.cerberus,
  // 新增 8 帧怪物
  monster_hellhound:  SPRITE.monster_hellhound,
  monster_braindevil: SPRITE.monster_braindevil,
  monster_direwolf:   SPRITE.monster_direwolf,
...
const SUMMON_POOL = [
  ...
  // ===== 紅色新英雄（非人型）=====
  { id: 's47', name: '冰霜狼', rarity: 'red', spriteKey: 'hero_frost_wolf', role: 'dps', classRestriction: ['warrior','rogue'], race: 'beast',
    stats: { atk: 72, def: 12, hpMax: 240, crit: 18, critDmg: 45 },
    skill: { name: '寒冰撕咬', desc: '冰凍之牙造成240%暴擊傷害並減速', dmgMult: 2.4, cd: 6 } },
  { id: 's48', name: '暗影獸', rarity: 'red', spriteKey: 'hero_dark_beast', role: 'dps', classRestriction: ['warrior','rogue','warlock'], race: 'beast',
    stats: { atk: 75, def: 10, hpMax: 210, crit: 20, critDmg: 50 },
    skill: { name: '暗影咆哮', desc: '暗影衝擊造成260%範圍傷害', dmgMult: 2.6, aoe: true, cd: 7 } },
  { id: 's49', name: '雷霆熊', rarity: 'red', spriteKey: 'hero_thunder_bear', role: 'tank', classRestriction: ['warrior','paladin'], race: 'beast',
    stats: { atk: 45, def: 42, hpMax: 650, crit: 5, critDmg: 20 },
    skill: { name: '雷霆震擊', desc: '雷霆重擊造成200%範圍傷害並眩暈', dmgMult: 2.0, aoe: true, cd: 8 } },
  // ===== 紫色新英雄 =====
  { id: 's50', name: '火焰元素', rarity: 'purple', spriteKey: 'hero_fire_elemental', role: 'dps', classRestriction: ['mage','warlock'], race: 'elemental',
    stats: { atk: 110, def: 12, hpMax: 260, crit: 15, critDmg: 55 },
    skill: { name: '烈焰風暴', desc: '火焰爆發造成280%範圍傷害', dmgMult: 2.8, aoe: true, cd: 8 } },
  { id: 's51', name: '黃金獅鷲', rarity: 'purple', spriteKey: 'hero_golden_griffin', role: 'dps', classRestriction: ['warrior','archer'], race: 'beast',
    stats: { atk: 100, def: 20, hpMax: 320, crit: 20, critDmg: 45 },
    skill: { name: '俯衝爪擊', desc: '飛天俯衝造成260%暴擊傷害', dmgMult: 2.6, cd: 7 } },
  { id: 's52', name: '不死騎士', rarity: 'purple', spriteKey: 'hero_undead_knight', role: 'tank', classRestriction: ['warrior','paladin'], race: 'undead',
    stats: { atk: 55, def: 55, hpMax: 800, crit: 6, critDmg: 25 },
    skill: { name: '亡靈護盾', desc: '不死之力護盾吸收30%傷害並反擊', shieldPct: 0.3, dmgMult: 1.2, cd: 9 } },
  { id: 's53', name: '石頭泰坦', rarity: 'purple', spriteKey: 'hero_stone_titan', role: 'tank', classRestriction: ['warrior','paladin'], race: 'golem',
    stats: { atk: 48, def: 65, hpMax: 900, crit: 3, critDmg: 20 },
    skill: { name: '大地之怒', desc: '泰坦重擊造成250%範圍傷害', dmgMult: 2.5, aoe: true, cd: 9 } },
  // ===== 金色新英雄 =====
  { id: 's54', name: '魔女', rarity: 'gold', spriteKey: 'hero_demoness', role: 'dps', classRestriction: ['mage','warlock'], race: 'demon',
    stats: { atk: 180, def: 25, hpMax: 400, crit: 22, critDmg: 65 },
    skill: { name: '魔獄隕星', desc: '召喚隕星造成350%範圍傷害並治療', dmgMult: 3.5, aoe: true, healPct: 0.2, cd: 10 } },
  // ===== 紫色新英雄（非人型）=====
  { id: 's55', name: '鳳凰', rarity: 'purple', spriteKey: 'hero_phoenix', role: 'dps', classRestriction: ['warrior','mage','archer','warlock'], race: 'divine',
    stats: { atk: 95, def: 10, hpMax: 240, crit: 12, critDmg: 50, atkPct: 15, critAdd: 10, fireDmgPct: 20 },
    skill: { name: '涅槃烈焰', desc: '鳳凰之火造成260%範圍傷害並燃燒敵人', dmgMult: 2.6, aoe: true, dot: { type: 'burn', dmg: 10, duration: 5 }, cd: 8 } },
  // ===== 紅色新英雄（非人型）=====
  { id: 's56', name: '樹人', rarity: 'red', spriteKey: 'hero_treant', role: 'tank', classRestriction: ['warrior','paladin','mage'], race: 'elemental',
    stats: { atk: 40, def: 35, hpMax: 500, crit: 3, critDmg: 18, defPct: 20, hpPct: 15, hpRegenPct: 10 },
    skill: { name: '自然之怒', desc: '巨樹重擊造成180%範圍傷害並恢復生命', dmgMult: 1.8, aoe: true, healPct: 0.15, cd: 9 } },
  // ===== 紫色 3个 =====
...
const PET_POOL = [
  ...
  // ===== 新增 8 幀守護寵物 =====
  { id: 'p41', name: '火蜥蜴', rarity: 'green', spriteKey: 'pet_fire_lizard', desc: '噴吐烈焰的小蜥蜴',
    stats: { atk: 10, def: 2, hpMax: 22, crit: 5, critDmg: 15 } },
  { id: 'p42', name: '小惡魔', rarity: 'green', spriteKey: 'pet_imp', desc: '調皮搗蛋的小惡魔',
    stats: { atk: 12, def: 1, hpMax: 18, crit: 7, critDmg: 18 } },
  { id: 'p43', name: '妖精', rarity: 'blue', spriteKey: 'pet_fairy_new', desc: '森林裡的妖精，擅長魔法',
    stats: { atk: 20, def: 3, hpMax: 50, crit: 8, critDmg: 22 } },
  { id: 'p44', name: '魔女貓', rarity: 'blue', spriteKey: 'pet_witch_cat', desc: '魔女身邊的神秘黑貓',
    stats: { atk: 18, def: 4, hpMax: 55, crit: 10, critDmg: 20 } },
  { id: 'p45', name: '小幽靈', rarity: 'blue', spriteKey: 'pet_ghost_new', desc: '飄蕩在夜空中的幽靈',
    stats: { atk: 16, def: 5, hpMax: 65, crit: 6, critDmg: 18 } },
  { id: 'p46', name: '冰精靈', rarity: 'red', spriteKey: 'pet_ice_sprite', desc: '寒冰之境誕生的精靈',
    stats: { atk: 38, def: 8, hpMax: 100, crit: 10, critDmg: 28 } },
  { id: 'p47', name: '暗影蛇', rarity: 'red', spriteKey: 'pet_shadow_serpent', desc: '潛伏暗影中的毒蛇',
    stats: { atk: 42, def: 6, hpMax: 80, crit: 14, critDmg: 32 } },
  { id: 'p48', name: '金龍幼崽', rarity: 'purple', spriteKey: 'pet_golden_whelp', desc: '至尊黃金龍的幼崽',
    stats: { atk: 65, def: 18, hpMax: 220, crit: 12, critDmg: 35 } },
  // ===== 新增 8 幀守護寵物（第二彈）=====
  { id: 'p49', name: '幼龍', rarity: 'red', spriteKey: 'pet_babydragon', desc: '天賦異稟的年幼飛龍，攻勢凌厲',
    stats: { atk: 25, def: 8, hpMax: 120, crit: 6, critDmg: 20, atkPct: 10, critDmgPct: 15, expPct: 5 } },
  { id: 'p50', name: '鬼火', rarity: 'blue', spriteKey: 'pet_wisp', desc: '幽幽飄蕩的靈魂之火，精通法術',
    stats: { atk: 12, def: 3, hpMax: 60, crit: 5, critDmg: 15, mpRegenPct: 20, skillDmgPct: 8, goldPct: 10 } },
];
...
const TRANSFORM_POOL = [
  ...
  { id: 't_demonlord', name: '惡魔領主', rarity: 'gold', spriteKey: 'tf_demonlord',
    classRestriction: null,
    desc: '統領深淵大軍的惡魔領主，壓倒性的力量碾壓一切',
    stats: { atk: 300, def: 100, hpMax: 800, mpMax: 200, crit: 15, critDmg: 40, hit: 10, allStatPct: 15, walkSpeedPct: 10, atkSpeedPct: 10, pvpDmgPct: 5 } },
  ...
  { id: 't_frostgiant', name: '冰霜巨人', rarity: 'purple', spriteKey: 'tf_frostgiant',
    classRestriction: null,
    desc: '北境冰霜巨人，以凍結之力統治雪原',
    stats: { atk: 160, def: 70, hpMax: 500, mpMax: 100, crit: 10, critDmg: 25, hit: 6, allStatPct: 10, walkSpeedPct: 5, atkSpeedPct: 5, skillDmgPct: 8 } },
...
function assignActiveAIToCurrentMap() {
  ...
  // 目標：8-12 個，取隨機值（避免同地圖過多AI導致卡頓）
  const target = 8 + Math.floor(Math.random() * 5); // 8~12
...
const SPRITE_SIZE = { hero: { w: 64, h: 80 }, enemy: { w: 50, h: 56 }, summon: { w: 46, h: 52 }, pet: { w: 38, h: 42 } };
...
function updateTransformVisual() {
  ...
  if (tf) {
    ...
    if (aura) {
      ...
      const lightningSrc = tf.rarity === 'gold' ? 'assets/Bm7QnJD8GM.png' : (tf.rarity === 'purple' ? 'assets/38AbJxx35a.png' : '');
      aura.querySelectorAll('.effect-burst').forEach(img => { img.src = lightningSrc; });
      aura.querySelectorAll('.effect-magic-circle').forEach(img => { img.src = 'assets/JnjUPjCz1B.png'; });
      // 啟動上升粒子生成器
    ...
    if (siegeUnit) {
      ...
      if (tf && tf.unlocked) {
        ...
        if (siegeAura) {
          ...
          siegeAura.querySelectorAll('.effect-magic-circle').forEach(img => { img.src = 'assets/JnjUPjCz1B.png'; });
        }
      } else {
        if (siegeAura) {
...
function renderNPCs(map) {
  ...
  map.npcs.forEach(npc => {
    ...
    // 為同 id 的多個 NPC（如多個警衛）生成唯一 uid
    const npcUid = 'npc_' + npc.id + '_' + npcIdx;
    npcIdx++;
    elDiv.dataset.npcUid = npcUid;
    ...
    if (isImg && multiFrame) {
      ...
      spriteHTML = `
        <div class="npc-sprite-wrap sprite-multi-frame" style="position:relative;width:56px;height:64px">
          <img class="unit-sprite-img sprite-frame-idle" src="${sp.idle}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:contain;display:block;filter:${filter}" alt=""/>
          <img class="unit-sprite-img sprite-frame-walk sprite-frame-walk-1" src="${walkSrcs[0]}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:contain;display:none;filter:${filter}" alt=""/>
          <img class="unit-sprite-img sprite-frame-walk sprite-frame-walk-2" src="${walkSrcs[1]}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:contain;display:none;filter:${filter}" alt=""/>
          <img class="unit-sprite-img sprite-frame-walk sprite-frame-walk-3" src="${walkSrcs[2]}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:contain;display:none;filter:${filter}" alt=""/>
          <img class="unit-sprite-img sprite-frame-walk sprite-frame-walk-4" src="${walkSrcs[3]}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:contain;display:none;filter:${filter}" alt=""/>
          <img class="unit-sprite-img sprite-frame-attack sprite-frame-attack-1" src="${atkSrcs[0]}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:contain;display:none;filter:${filter}" alt=""/>
          <img class="unit-sprite-img sprite-frame-attack sprite-frame-attack-2" src="${atkSrcs[1]}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:contain;display:none;filter:${filter}" alt=""/>
          <img class="unit-sprite-img sprite-frame-hit" src="${sp.hit || sp.idle}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:contain;display:none;filter:${filter}" alt=""/>
        </div>
      `;
      ...
      spriteHTML = `
        <img class="npc-sprite-img" src="${sp.idle}" alt="${npc.name}" style="width:100%;height:100%;object-fit:contain;display:block;filter:${filter}"/>
      `;
    } else {
...
function spawnMonsters() {
  ...
  map.monsters.forEach(spec => {
    for (let i = 0; i < spec.count; i++) {
      ...
      let behavior;
      if (spec.behavior) {
        behavior = spec.behavior; // 怪物指定了固定行为
      } else {
        const isAggro = aggroCountPool > 0 && Math.random() > 0.5;
        if (isAggro) aggroCountPool--;
        behavior = isAggro ? 'aggro' : 'passive';
      }
      pending.push({ type: spec.type, name: spec.name, level, behavior });
    }
  });
  ...
  function spawnBatch() {
    ...
    if (idx < pending.length) {
      ...
      // 全部生成完畢再生成 Boss
      if (map.boss) spawnMapBoss(map, 'boss');
      if (map.worldBoss) spawnMapBoss(map, 'worldBoss');
...
function spawnMapBoss(map, slot = 'boss') {
  const bsKey = map.id + ':' + slot;
  const bs = bossState[bsKey];
  if (bs && bs.respawnAt && Date.now() < bs.respawnAt) return; // 冷卻中
  if (bs?.spawned) return;

  const boss = slot === 'worldBoss' ? map.worldBoss : map.boss;
  if (!boss) return;
  ...
  if (wasMulti !== isMulti || isMulti) {
    // 重建sprite DOM：先移除旧DOM，再重新创建
    const oldEl = m.el;
  ...
  if (elDiv) {
    ...
    // Boss 精靈放大：多幀Boss用2.0倍，單幀Boss用1.5倍
    ...
    if (spriteWrap) {
      ...
      const scale = (m.sprite && m.sprite.multiFrame) ? 2.0 : 1.5;
    ...
    // 多幀Boss：初始化8幀動畫狀態（普通怪物在createMonsterSprite中处理，但Boss在spawnMapBoss中改了sprite后需要重新初始化）
    if (m.sprite && m.sprite.multiFrame) {
      unitAnimState.delete(m.uid);
      initUnitAnimState(m.uid);
      elDiv.classList.add('enemy-multiframe');
    }
...
function onBossKilled(mapId, boss, slot = 'boss') {
  ...
  bossState[mapId + ':' + slot] = { respawnAt: Date.now() + respawnSec * 1000, spawned: false, slot: slot };
  addLog('system', `擊敗了 ${boss.name}！重生時間：${respawnSec}秒`);
}

function getBossRespawnTime(mapId, slot = 'boss') {
  const bs = bossState[mapId + ':' + slot];
...
function checkBossRespawn() {
  ...
  if (!map) return;
  const slots = [];
  if (map.boss) slots.push('boss');
  if (map.worldBoss) slots.push('worldBoss');
  for (const slot of slots) {
    const bsKey = GS.currentMap + ':' + slot;
    const bs = bossState[bsKey];
    if (!bs || bs.spawned) continue;
    if (bs.respawnAt && Date.now() >= bs.respawnAt) {
      spawnMapBoss(map, slot);
    }
  }
}
...
function createMonsterSprite(m) {
  ...
  // 多帧怪物使用完整8帧结构（和玩家一样），单帧怪物用精简结构+CSS动画
  const isMultiFrame = !!(m.sprite && m.sprite.multiFrame);
  elDiv.innerHTML = buildSpriteHTML(m.sprite, 'enemy', !isMultiFrame);
  if (isMultiFrame) {
    initUnitAnimState(m.uid);
    // 为怪物添加额外的多帧标记类，便于CSS微调
    elDiv.classList.add('enemy-multiframe');
  }
  // 填充名字（等級已隱藏，僅顯示名稱）
  ...
  positionUnit(elDiv, m.x, m.y, 'enemy');
  m.el = elDiv;
  // 只有非多帧怪物使用纯CSS动画模式；多帧怪物走updateSpriteFrames的8帧JS驱动
}
...
// 完整 8 幀英雄召喚（用於 spriteKey 英雄，走完整動畫結構）
function createSummonSpriteFull(s) {
  const elDiv = document.createElement('div');
  elDiv.className = 'world-unit summon idle';
  elDiv.dataset.id = s.id;
  elDiv.innerHTML = buildSpriteHTML(s.sprite, 'summon', false); // lean=false 用完整8幀
  const info = elDiv.querySelector('.unit-info');
  info.querySelector('.unit-name').textContent = s.name;
  info.querySelector('.unit-level-tag').textContent = '';
  worldLayer.appendChild(elDiv);
...
// 守護寵物世界跟隨精靈
function createPetFollowerSprite(p) {
  const elDiv = document.createElement('div');
  elDiv.className = 'world-unit pet-follower idle';
  elDiv.dataset.id = p.id;
  const lean = !p.multiFrame;
  elDiv.innerHTML = buildSpriteHTML(p.sprite, 'pet', lean);
  const info = elDiv.querySelector('.unit-info');
  if (info) {
    const nameEl = info.querySelector('.unit-name');
    if (nameEl) nameEl.textContent = p.name;
    const lvlEl = info.querySelector('.unit-level-tag');
    if (lvlEl) lvlEl.textContent = '';
  }
  worldLayer.appendChild(elDiv);
  positionUnit(elDiv, p.x, p.y, 'pet');
  if (p.multiFrame) initUnitAnimState(p.id);
  return elDiv;
}
...
function updateSpriteFrames(dt) {
  ...
  if (worldLayer && GS.monsters && GS.monsters.length > 0) {
    for (const m of GS.monsters) {
      ...
      const el = m.el || worldLayer.querySelector(`[data-id="${m.uid}"]`);
      if (el) updateUnitAnimFrame(m.uid, m.state, el);
    }
  }
...
// NPC 8 幀呼吸動畫：idle 狀態下慢速輪播 walk 幀（用於 NPC 站立呼吸感）
const NPC_BREATH_FRAME_DURATION = 700; // 每帧 700ms，比走路慢很多
function updateNPCAnimFrames(dt) {
  if (!npcLayer) return;
  const dtMs = dt * 1000;
  const npcEls = npcLayer.querySelectorAll('.npc-unit');
  npcEls.forEach(el => {
    const uid = el.dataset.npcUid;
    if (!uid) return;
    const anim = unitAnimState.get(uid);
    if (!anim) return;
    const wrap = el.querySelector('.npc-sprite-wrap.sprite-multi-frame');
    if (!wrap) return;
    // NPC 永遠處於 idle 呼吸狀態：慢速循環 walk 4 帧
    anim.animTimer -= dtMs;
    if (anim.animTimer > 0) return;
    const walkFrames = wrap.querySelectorAll('.sprite-frame-walk');
    const idleImg = wrap.querySelector('.sprite-frame-idle');
    if (walkFrames.length === 0) return;
    anim.animFrame = (anim.animFrame + 1) % walkFrames.length;
    anim.animTimer = NPC_BREATH_FRAME_DURATION;
    // 隐藏所有帧，显示当前 walk 帧
    if (idleImg) idleImg.style.display = 'none';
    walkFrames.forEach(img => img.style.display = 'none');
    if (walkFrames[anim.animFrame]) walkFrames[anim.animFrame].style.display = 'block';
  });
}
...
function updatePlayer(dt) {
  ...
  if (p.mp < mpMax) {
    let mpRegenRate = 0.02;
    const petBonus = getPetBonus();
    if (petBonus.mpRegenPct) mpRegenRate = mpRegenRate * (1 + petBonus.mpRegenPct / 100);
    p.mp = Math.min(mpMax, p.mp + mpMax * mpRegenRate * dt);
  }
...
function doPlayerNormalAttack(target, isAITarget) {
  ...
  if (isAITarget) {
    const tfInfo = TRANSFORM_POOL.find(t => t.id === p.transformId);
    if (tfInfo?.stats?.pvpDmgPct) dmg = Math.floor(dmg * (1 + tfInfo.stats.pvpDmgPct / 100));
  }
  ...
  if (isAITarget) {
    ...
    if (target.hp <= 0) {
      ...
      const petBonus = getPetBonus();
      const finalExp = Math.floor(expGain * (1 + petBonus.expPct / 100));
      const finalGold = Math.floor(goldGain * (1 + petBonus.goldPct / 100));
      GS.player.exp += finalExp;
      GS.resources.gold += finalGold;
      p.kills = (p.kills || 0) + 1;
      addLog('kill', `擊敗【${target.name}】，獲得 ${finalExp} 經驗，${finalGold} 金幣`);
...
function dealSkillDamage(target, baseDmg, effectType, skill, isAoe) {
  ...
  // 變身技能傷害加成
  const tfInfo = TRANSFORM_POOL.find(t => t.id === p.transformId);
  if (tfInfo?.stats?.skillDmgPct) dmg = Math.floor(dmg * (1 + tfInfo.stats.skillDmgPct / 100));
  // 寵物技能傷害加成
  const pet = GS.ownedPets?.find(pt => pt.id === GS.equippedPetId);
  if (pet) {
    const petData = PET_POOL.find(pp => pp.id === pet.id) || pet;
    if (petData?.stats?.skillDmgPct) dmg = Math.floor(dmg * (1 + petData.stats.skillDmgPct / 100));
  }
  // 英雄火屬性傷害加成（僅對火/火球/隕石等火系技能生效）
  const fireEffects = ['fire', 'fireball', 'meteor', 'inferno'];
  const hero = GS.ownedHeroes?.find(h => h.id === GS.equippedHeroId);
  if (hero) {
    const heroData = SUMMON_POOL.find(s => s.id === hero.id) || hero;
    if (heroData?.stats?.fireDmgPct && fireEffects.includes(effectType)) {
      dmg = Math.floor(dmg * (1 + heroData.stats.fireDmgPct / 100));
    }
  }
...
function onMonsterDead(m) {
  ...
  if (m.isBoss) {
    const map = getAllMaps()[GS.currentMap];
    const slot = m.bossSlot || 'boss';
    const bossData = slot === 'worldBoss' ? map?.worldBoss : map?.boss;
    if (bossData) onBossKilled(GS.currentMap, bossData, slot);
  }
...
function respawnMonster() {
  ...
  const behavior = spec.behavior || (Math.random() > 0.6 ? 'aggro' : 'passive');
  createMonster(spec.type, spec.name, level, behavior);
}
...
function updatePetFollower(dt) {
  const p = GS.petFollower;
  if (!p || !worldLayer) return;
  const dx = GS.player.x - 22 - p.x;
  const dy = GS.player.y + 10 - p.y;
  const dist = Math.hypot(dx, dy);
  const speed = 85;
  if (dist > 30) {
  ...
  const elDiv = worldLayer.querySelector(`[data-id="${p.id}"]`);
  if (elDiv) {
    positionUnit(elDiv, p.x, p.y, 'pet');
    elDiv.classList.toggle('face-left', p.facing === 'left');
    const newState = p.state === 'walking' ? 'walking' : 'idle';
    if (p._renderState !== newState) {
      elDiv.classList.remove('idle','walking');
      elDiv.classList.add(newState);
      p._renderState = newState;
    }
    if (p.multiFrame) {
      updateUnitAnimFrame(p.id, newState, elDiv);
    }
  }
}
...
function getPetBonus() {
  ...
  if (!pet) return { expPct: 0, goldPct: 0, mpRegenPct: 0, skillDmgPct: 0, atkPct: 0, critDmgPct: 0 };
  const petData = PET_POOL.find(pp => pp.id === pet.id) || pet;
  const s = petData?.stats || {};
  return {
    expPct: Number(s.expPct) || 0,
    goldPct: Number(s.goldPct) || 0,
    mpRegenPct: Number(s.mpRegenPct) || 0,
    skillDmgPct: Number(s.skillDmgPct) || 0,
    atkPct: Number(s.atkPct) || 0,
    critDmgPct: Number(s.critDmgPct) || 0,
  };
}
...
function getTotalAtk() {
  ...
  // 英雄百分比加成（在羁绊之后、其他加成之前叠乘）
  if (hero?.stats?.atkPct) atk = atk * (1 + hero.stats.atkPct / 100);
  // 寵物百分比加成
  if (pet?.stats?.atkPct) atk = atk * (1 + pet.stats.atkPct / 100);
...
function getTotalDef() {
  ...
  // 英雄百分比加成
  if (hero?.stats?.defPct) def = def * (1 + hero.stats.defPct / 100);
...
function getTotalHpMax() {
  ...
  // 英雄百分比加成
  if (hero?.stats?.hpPct) hp = hp * (1 + hero.stats.hpPct / 100);
  ...
  hp += rb.hpMax || 0;
  // 變身全屬性加成
  if (tfInfo?.stats?.allStatPct) hp = hp * (1 + tfInfo.stats.allStatPct / 100);
  if (isNaN(hp)) hp = 100;
  return hp;
}
function getTotalMpMax() {
  ...
  mp += ecb.mpMax || 0;
  // 變身全屬性加成
  if (tfInfo?.stats?.allStatPct) mp = mp * (1 + tfInfo.stats.allStatPct / 100);
  if (isNaN(mp)) mp = 100;
  return mp;
}
function getTotalCrit() {
  ...
  // 英雄百分比/额外加成
  if (hero?.stats?.critAdd) c += Number(hero.stats.critAdd) || 0;
  ...
  c += rb.crit || 0;
  // 變身全屬性加成
  if (tfInfo?.stats?.allStatPct) c = c * (1 + tfInfo.stats.allStatPct / 100);
  if (isNaN(c)) c = 0;
  return c;
}
function getTotalCritDmg() {
  ...
  // 寵物暴擊傷害百分比加成
  if (pet?.stats?.critDmgPct) cd = cd * (1 + pet.stats.critDmgPct / 100);
  const cb = getCollectionBonus();
  cd += cb.critDmg || 0;
  ...
  cd += ecb.critDmg || 0;
  // 變身全屬性加成
  if (tfInfo?.stats?.allStatPct) cd = cd * (1 + tfInfo.stats.allStatPct / 100);
  if (isNaN(cd)) cd = 150;
  return cd;
}
...
function renderCollectionPage() {
  // 計算總蒐藏進度
  const cats = [
    { key: 'hero',      name: '英雄蒐藏', icon: ITEM_ICONS.weapon },
    { key: 'pet',       name: '守護蒐藏', icon: ITEM_ICONS.helmet },
    { key: 'transform', name: '變身蒐藏', icon: ITEM_ICONS.gem },
    { key: 'equip',     name: '裝備蒐藏', icon: ITEM_ICONS.armor },
    { key: 'item',      name: '道具蒐藏', icon: ITEM_ICONS.chest },
    { key: 'monster',   name: '怪物圖鑑', icon: ITEM_ICONS.enhance_stone },
  ];
...
function showCodexDetail(id, type) {
  ...
  const nameMap = { atk: '攻擊力', def: '防禦力', hpMax: '生命值', crit: '暴擊率', critDmg: '暴擊傷害', mpMax: '魔力', hit: '命中', dodge: '閃躲', walkSpeedPct: '移動速度%', atkSpeedPct: '攻擊速度%', expPct: '經驗加成%', dropPct: '掉寶率', shield: '護盾值', hpRegen: '生命回復', mpRegen: '魔力回復', atkPct: '攻擊力%', defPct: '防禦力%', hpPct: '生命%', critAdd: '暴擊率', critDmgPct: '暴擊傷害%', fireDmgPct: '火屬性傷害%', hpRegenPct: '自然回復%', mpRegenPct: 'MP回復%', skillDmgPct: '技能傷害%', goldPct: '金幣加成%' };
  ...
  if (type === 'hero') {
    ...
    stats = item.stats || {};
    skill = item.skill || {};
    spriteHtml = owned && (item.sprite || item.spriteKey) ? spriteEmojiHTML(item.sprite || SPRITE[item.spriteKey], 120) : '';
  } else if (type === 'pet') {
...
function showBuffDetail(buff) {
  ...
  const statsStr = buff.stats && Object.keys(buff.stats).length > 0
    ? '<div style="margin-top:6px;color:var(--gold)">' + Object.entries(buff.stats).map(([k, v]) => {
         const nameMap = { atk: '攻擊', def: '防禦', hpMax: '生命', atkSpeedPct: '攻速', walkSpeedPct: '移速', crit: '暴擊', critDmg: '暴傷', expPct: '經驗', dropPct: '掉寶率', dodge: '閃躲', shield: '護盾值', allStatPct: '全屬性', pvpDmgPct: 'PVP傷害', skillDmgPct: '技能傷害' };
...
function equipHero(heroId) {
  ...
  if (hero) {
    // 有 spriteKey 的英雄使用自身 8 帧独立图资；无 spriteKey 的按职业映射
    const keySprite = hero.spriteKey ? SPRITE[hero.spriteKey] : null;
    const clsId = resolveClassId(hero.classId || 'warrior');
    const baseSprite = keySprite || SPRITE[clsId] || SPRITE.warrior;
    const rarity = hero.rarity || 'white';
    const rarityGlow = {
    ...
    const summon = {
      ...
      multiFrame: !!heroSprite.multiFrame,
    };
    summon.targetX = summon.x; summon.targetY = summon.y;
    GS.summons.push(summon);
    // spriteKey 英雄用完整 8 幀結構（lean=false）；職業圖沿用 lean 模式
    const el = keySprite ? createSummonSpriteFull(summon) : createSummonSprite(summon);
    // 加品质光晕class
...
function equipPet(petId) {
  ...
  // 移除舊的寵物跟隨單位
  document.querySelectorAll('.world-unit.pet-follower').forEach(el => el.remove());
  ...
  if (pet) {
    ...
    const spriteData = { ...petSprite, glow: rarityGlow[rarity] || rarityGlow.white };
    const follower = {
      id: 'pet_' + pet.id, name: pet.name, sprite: spriteData,
      rarity: rarity, isPetFollower: true, multiFrame: !!petSprite.multiFrame,
      x: GS.player.x - 20, y: GS.player.y + 8,
      targetX: 0, targetY: 0,
      state: 'idle', facing: 'right',
    };
    follower.targetX = follower.x; follower.targetY = follower.y;
    GS.petFollower = follower;
    const el = createPetFollowerSprite(follower);
    if (el) el.classList.add('rarity-' + rarity);
  } else {
    GS.petFollower = null;
  }
  updateUI();
          ...
          ${displayPool.map(t => {
            ...
            const statText = Object.entries(t.stats || {}).map(([k, v]) => {
              const nameMap = {
                ...
                walkSpeedPct: '移速', dodge: '閃躲', allStatPct: '全屬性',
                pvpDmgPct: 'PVP傷害', skillDmgPct: '技能傷害'
              };
              const pctKeys = ['atkSpeedPct','moveSpeedPct','walkSpeedPct','hpPct','mpPct','defPct','atkPct','crit','critDmg','evasion','dodge','hit','allStatPct','pvpDmgPct','skillDmgPct'];
        ...
        <div class="transform-grid tf-grid-3col">
          ${displayPool.map(h => {
            ...
            const equipped = GS.equippedHeroId === h.id;
             ...
             const sprObj = h.spriteKey ? SPRITE[h.spriteKey] : (typeof h.sprite === 'string' ? SPRITE[h.sprite] : h.sprite);
             const sprIdle = sprObj?.idle || '';
            ...
            return `
              <div class="tf-card rarity-badge rarity-${h.rarity || 'white'} ${equipped ? 'equipped' : ''}" data-hero-id="${h.id}">
                ...
                <div class="tf-card-icon">
                  <img src="${sprIdle}" style="width:100%;height:100%;object-fit:contain" onerror="this.style.display='none'"/>
                </div>
  ...
  el.pageContent.querySelectorAll('[data-tf-card]').forEach(card => {
    card.addEventListener('click', e => {
      ...
      const statText = Object.entries(tf.stats || {}).map(([k, v]) => {
        const nameMap = { atk: '攻擊', def: '防禦', hpMax: '生命', crit: '暴擊率', critDmg: '暴擊傷害', mpMax: '魔力', walkSpeedPct: '移速', atkSpeedPct: '攻速', dodge: '閃躲', hit: '命中', allStatPct: '全屬性', pvpDmgPct: 'PVP傷害', skillDmgPct: '技能傷害' };
        const pctKeys = ['crit','critDmg','walkSpeedPct','atkSpeedPct','allStatPct','pvpDmgPct','skillDmgPct','dodge','hit'];
        return `${nameMap[k] || k} +${v}${pctKeys.includes(k) ? '%' : ''}`;
      }).join(' · ');
...
function updateMinimap() {
  ...
  const bossSlots = [];
  if (mapObj?.boss) bossSlots.push({ slot: 'boss', data: mapObj.boss });
  if (mapObj?.worldBoss) bossSlots.push({ slot: 'worldBoss', data: mapObj.worldBoss });
  for (const bsInfo of bossSlots) {
    const bs = bossState[GS.currentMap + ':' + bsInfo.slot];
    if (bs && !bs.spawned && bs.respawnAt > Date.now()) {
      const remain = Math.ceil((bs.respawnAt - Date.now()) / 1000);
      const mins = Math.floor(remain / 60);
      const secs = remain % 60;
      const bx = bsInfo.data.x * sx;
      const by = bsInfo.data.y * sy;
      const isWorld = bsInfo.slot === 'worldBoss';
      ctx.fillStyle = isWorld ? 'rgba(255,50,100,0.5)' : 'rgba(255,100,100,0.4)';
      ctx.strokeStyle = isWorld ? 'rgba(255,80,120,0.7)' : 'rgba(255,100,100,0.6)';
      ctx.lineWidth = 1;
      ctx.beginPath();
      ctx.arc(bx, by, isWorld ? 5 : 4, 0, Math.PI * 2);
      ctx.fill();
      ctx.stroke();
      ctx.fillStyle = isWorld ? '#ff6080' : '#ff8080';
...
function gameLoop(ts) {
  ...
  if (!GS.paused) {
    ...
    try { updatePetFollower(dt); } catch (e) { console.error('updatePetFollower error:', e); }
    ...
    if (GS.player.hp > 0 && GS.player.hp < getTotalHpMax() && GS.player.state === 'idle') {
      let regenRate = 0.005;
      const hero = GS.ownedHeroes?.find(h => h.id === GS.equippedHeroId);
      const heroData = hero ? (SUMMON_POOL.find(s => s.id === hero.id) || hero) : null;
      if (heroData?.stats?.hpRegenPct) regenRate += heroData.stats.hpRegenPct / 100 / 10; // hpRegenPct 为每10秒最大生命回复百分比
      GS.player.hp = Math.min(getTotalHpMax(), GS.player.hp + getTotalHpMax() * regenRate * dt);
    }
  ...
  try { updateNPCAnimFrames(dt); } catch (e) { console.error('updateNPCAnimFrames error:', e); }
